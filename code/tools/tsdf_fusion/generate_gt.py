...
def parse_args():
    ...
    parser.add_argument("--data_path", metavar="DIR",
                        help="path to raw dataset", default='/home/huiyu/Documents/Datasets2/ScanNet')
...
def process_with_single_worker(args, scannet_files):
    for scene in tqdm(scannet_files):
        ...
        if args.dataset == 'scannet':
            n_imgs = len([f for f in os.listdir(os.path.join(args.data_path, scene, 'color')) if f.endswith('.jpg')])
